    ...
    return (
        <div className={`min-h-screen font-sans transition-colors duration-300 relative overflow-hidden flex items-center justify-center ${darkMode ? 'bg-zinc-950 text-zinc-100' : 'bg-zinc-50 text-zinc-900'}`}>
            ...
            <div className="relative z-10 w-full max-w-md px-6 py-12 md:px-8">
                ...
                {/* Card */}
                <div className={`rounded-2xl shadow-xl backdrop-blur-md border p-8 ${darkMode ? 'bg-zinc-900/50 border-white/10' : 'bg-white/80 border-zinc-200'}`}>
                    ...
                    <form className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="email" className={`block text-sm font-medium mb-2 ${darkMode ? 'text-zinc-300' : 'text-zinc-700'}`}>Email Address</label>
                            <input
                                type="email"
                                id="email"
                                className={`w-full px-4 py-3 rounded-xl border outline-none transition-all duration-300 focus:ring-2 focus:ring-indigo-500/20 ${darkMode ? 'bg-zinc-950/50 border-zinc-800 text-white focus:border-indigo-500' : 'bg-zinc-50 border-zinc-300 text-zinc-900 focus:border-indigo-500'}`}
                        ...
                        <div>
                            <label htmlFor="password" className={`block text-sm font-medium mb-2 ${darkMode ? 'text-zinc-300' : 'text-zinc-700'}`}>Password</label>
                            <input
                                type="password"
                                id="password"
                                className={`w-full px-4 py-3 rounded-xl border outline-none transition-all duration-300 focus:ring-2 focus:ring-indigo-500/20 ${darkMode ? 'bg-zinc-950/50 border-zinc-800 text-white focus:border-indigo-500' : 'bg-zinc-50 border-zinc-300 text-zinc-900 focus:border-indigo-500'}`}
                        ...
                        <div>
                            <label htmlFor="confirm-password" className={`block text-sm font-medium mb-2 ${darkMode ? 'text-zinc-300' : 'text-zinc-700'}`}>Confirm Password</label>
                            <input
                                type="password"
                                id="confirm-password"
                                className={`w-full px-4 py-3 rounded-xl border outline-none transition-all duration-300 focus:ring-2 focus:ring-indigo-500/20 ${darkMode ? 'bg-zinc-950/50 border-zinc-800 text-white focus:border-indigo-500' : 'bg-zinc-50 border-zinc-300 text-zinc-900 focus:border-indigo-500'}`}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button className={`flex items-center justify-center gap-2 py-2.5 rounded-xl border transition-all duration-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 ${darkMode ? 'border-zinc-800 bg-zinc-900 text-white' : 'border-zinc-200 bg-white text-zinc-700'}`}>
